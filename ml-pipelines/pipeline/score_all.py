...
Usage:
  python score_all.py                    # score all 6 prediction pipelines
  python score_all.py donor-acquisition  # score one pipeline by key
